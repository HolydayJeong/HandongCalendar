...
function completeContentInsert(ret_obj) {
	...
	var url = current_url.setQuery('act','dispCalendarContentList').setQuery('calendar_srl','');
    location.href = url;
}
...
function completeContentDelete(ret_obj) {
    ...
    var url = current_url.setQuery('act','dispCalendarContentList').setQuery('calendar_srl','').setQuery('calendar_title','');
...
function completeAdminInsertBook(ret_obj) {
    ...
    var url = current_url.setQuery('act','dispCalendarAdminList').setQuery('module_srl','');
